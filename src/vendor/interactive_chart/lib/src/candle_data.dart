class CandleData {
  ...
  /// Overmind amherag data.
  final List<double>? amheragAbove;
  final List<double>? amheragBelow;
  final double? amheragMax;
  final double? amheragMin;
  ...
  CandleData({
    ...
    required this.amheragAbove,
    required this.amheragBelow,
    required this.amheragMax,
    required this.amheragMin,
    this.high,
    this.low,
    List<double?>? trends,
